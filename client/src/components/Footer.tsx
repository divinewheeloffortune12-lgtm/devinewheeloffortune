        ...
        <div className="grid gap-12 lg:grid-cols-12 pb-16">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-5 text-[13px] text-foreground/80 font-medium">
              <li>
                <a href="mailto:nattashasharrma1278@gmail.com" className="flex items-center gap-3 hover:text-primary transition-colors">
                  <Mail className="h-4 w-4 text-primary opacity-70" /> nattashasharrma1278@gmail.com
                </a>
              </li>
              <li>
