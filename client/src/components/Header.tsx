                ...
                <div className="absolute top-full left-0 w-full opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 bg-white shadow-xl border-t border-black/5 z-50">
                  <div className="container-full mx-auto px-4 py-8 grid grid-cols-4 gap-6">
                    ...
                    {categories.length > 0 && !isCategoriesLoading && (
                      <a href={homeHref("/#categories")} className="group/item flex flex-col items-center justify-center gap-2 bg-slate-50 hover:bg-primary/5 p-4 rounded-xl transition-colors border border-transparent hover:border-primary/20 shadow-sm hover:shadow-md h-full min-h-[80px]">
            ...
            <>
              ...
              >
                <div className="flex flex-col h-full bg-white">
                  ...
                  <Link to="/services" onClick={() => setOpen(false)} className="flex items-center gap-3 px-5 py-3.5 text-sm font-semibold text-foreground/80 hover:bg-black/5 hover:text-primary rounded-lg"><CalendarClock className="w-4 h-4 opacity-70" /> Services</Link>
